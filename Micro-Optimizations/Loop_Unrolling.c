        ...
        for (int till_x = 0; till_x < out_width; till_x += till_width){
            ...
            for(int y = 0; y < y_end; y += 1){
                for(int x = 0; x < x_end; x += 1){
                    ...
                    int32_t sum = 0;
                    sum += (int32_t)kernel[0][0] * (int32_t)image[till_y+y+0][till_x+x+0]; 
                    sum += (int32_t)kernel[0][1] * (int32_t)image[till_y+y+0][till_x+x+1]; 
                    sum += (int32_t)kernel[0][2] * (int32_t)image[till_y+y+0][till_x+x+2]; 
                    sum += (int32_t)kernel[1][0] * (int32_t)image[till_y+y+1][till_x+x+0]; 
                    sum += (int32_t)kernel[1][1] * (int32_t)image[till_y+y+1][till_x+x+1]; 
                    sum += (int32_t)kernel[1][2] * (int32_t)image[till_y+y+1][till_x+x+2]; 
                    sum += (int32_t)kernel[2][0] * (int32_t)image[till_y+y+2][till_x+x+0]; 
                    sum += (int32_t)kernel[2][1] * (int32_t)image[till_y+y+2][till_x+x+1]; 
                    sum += (int32_t)kernel[2][2] * (int32_t)image[till_y+y+2][till_x+x+2]; 
