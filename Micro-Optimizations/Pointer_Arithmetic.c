        ...
        for (int till_x = 0; till_x < out_width; till_x += till_width){
            ...
            for(int y = 0; y < y_end; y += 1){
                ...
                for(int x = 0; x < x_end; x += 1){
                    ...
                    int32_t sum = 0;
                    sum += (int32_t)kernel[0][0] * (int32_t)p0[0];
                    sum += (int32_t)kernel[0][1] * (int32_t)p0[1];
                    sum += (int32_t)kernel[0][2] * (int32_t)p0[2];
                    sum += (int32_t)kernel[1][0] * (int32_t)p1[0];
                    sum += (int32_t)kernel[1][1] * (int32_t)p1[1];
                    sum += (int32_t)kernel[1][2] * (int32_t)p1[2];
                    sum += (int32_t)kernel[2][0] * (int32_t)p2[0];
                    sum += (int32_t)kernel[2][1] * (int32_t)p2[1];
                    sum += (int32_t)kernel[2][2] * (int32_t)p2[2]; 
